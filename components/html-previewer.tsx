  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-background text-foreground">
      ...
      <div className="w-full max-w-2xl p-6 rounded-lg shadow-lg bg-card">
        <h1 className="text-2xl font-bold mb-4 text-center text-black">HTML Previewer</h1>
        ...
        <div className="grid gap-4">
          ...
          <Textarea
            ...
            className="p-4 rounded-lg border border-input bg-background text-foreground text-black"
            rows={8}
          />
          ...
          <div className="p-4 rounded-lg border border-input bg-background text-foreground text-black">
